...
SELECT
    ...
    ARRAY_AGG(DISTINCT e.species_group_id) AS species_group_ids,
    ARRAY_AGG(DISTINCT e.species_main_group_id) AS species_main_group_ids,
    COALESCE(
        JSONB_AGG(
            JSONB_BUILD_OBJECT(
