...
--! All pre-existing bunkerings need to be inserted as fuel_measurements to facilitate the migration to our new
--! fuel scheme. We therefore do not migrate them into this table.
CREATE TABLE bunkerings (
    bunkering_id SERIAL PRIMARY KEY,
    fuel_liter DOUBLE PRECISION NOT NULL,
