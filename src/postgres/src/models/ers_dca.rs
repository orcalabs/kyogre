...
impl TryFrom<fiskeridir_rs::ErsDca> for NewErsDca {
    ...
    fn try_from(v: fiskeridir_rs::ErsDca) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            gear_group_id: v.gear.gear_group_code.map(|v| v as i32),
            gear_main_group_id: v.gear.gear_main_group_code.map(|v| v as i32),
            ...
            vessel_width: opt_float_to_decimal(v.vessel_info.vessel_width)
                .change_context(PostgresError::DataConversion)?,
            main_species_fao_id: v.catch.main_species_fao_code.clone(),
            main_species_fiskeridir_id: v.catch.main_species_fdir_code.map(|v| v as i32),
            ...
            species_group_id: v.catch.species.species_group_code.map(|v| v as i32),
            species_main_group_id: v.catch.species.species_main_group_code.map(|v| v as i32),
