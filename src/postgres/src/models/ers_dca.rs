...
impl From<fiskeridir_rs::ErsDca> for NewErsDca {
    fn from(v: fiskeridir_rs::ErsDca) -> Self {
        Self {
...
impl From<&fiskeridir_rs::ErsDca> for NewErsDcaBody {
    fn from(v: &fiskeridir_rs::ErsDca) -> Self {
        Self {
            message_id: v.message_info.message_id as i64,
            ...
            area_grouping_end_id: v.area_grouping_end_code.clone().map(|v| v.into_inner()),
            area_grouping_start_id: v.area_grouping_start_code.clone().map(|v| v.into_inner()),
            ...
            herring_population_id: v.herring_population_code.clone().map(|v| v.into_inner()),
            herring_population_fiskeridir_id: v.herring_population_fdir_code.map(|v| v as i32),
            majority_species_fao_id: v
                .catch
                .majority_species_fao_code
                .clone()
                .map(|v| v.into_inner()),
