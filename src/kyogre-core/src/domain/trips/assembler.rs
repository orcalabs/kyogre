use crate::{
    Bound, FiskeridirVesselId, NewTrip, QueryRange, RelevantEventType, Trip, TripAssemblerError,
    TripAssemblerId, TripAssemblerOutboundPort, TripCalculationTimer, TripPrecisionError,
